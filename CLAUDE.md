...
| 模組 | 文件 | 主要程式碼 |
|:---|:---|:---|
| Live odds data pipeline | [`docs/modules/live-odds.md`](docs/modules/live-odds.md) | `Services/RecordsRepository.swift`、`Services/LiveOddsProvider.swift`、`Services/MockOddsWebSocketService.swift`（含 reconnect boundary）、`Stores/OddsStore.swift`、`Stores/Snapshot.swift` |
